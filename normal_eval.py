...
if __name__ == "__main__":
    ...
    normal_gt_stack = []
    normal_gs_stack = []
    #/is/cluster/fast/pyu/refnerf_results_3dgs/coffee_01/fw/test/ours_45000/n_Render/00000.png
    normal_from_depth_stack = []
    # /is/cluster/fast/pyu/refnerf_results_3dgs/coffee_01/fw/test/ours_45000/n_Depth/00000.png
