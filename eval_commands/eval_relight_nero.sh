...
objs=("bell" "cat" "horse" "potion" "tbell" "teapot")

methods=("df_alpha_0.01" "fw_alpha_0.01" "mixxed_alpha_0.01" "mixxed_reversed_alpha_0.01")

for obj in ${objs[@]}; do
    for method in ${methods[@]}; do
        python eval_relight_nero.py --output_dir /is/cluster/fast/pyu/results_refined/${obj}/${method} --gt_dir /is/cluster/fast/pyu/data/nero/relight_gt --obj ${obj} --result_file ./nero_refined_relight.json
    done
done