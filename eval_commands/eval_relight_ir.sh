...
for obj in ${objs[@]}; do
    for method in ${methods[@]}; do
        python relight_eval.py --output_dir /is/cluster/fast/pyu/results_refined/${obj}/${method} --gt_dir /is/cluster/fast/pyu/data/tensorir/${obj} --result_file ./ir_refined_relight.json
    done
done